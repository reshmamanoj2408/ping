...
public class ExternalConsentPageAdapter implements IdpAuthenticationAdapterV2
{
    ...
    private void renderForm(HttpServletRequest req, HttpServletResponse resp,  Map<String, Object> inParameters) throws AuthnAdapterException
    {
        ...
        Map<String, String> authorizationDetailsDescriptions = (Map<String, String>)inParameters.get(IN_PARAMETER_NAME_OAUTH_AUTHORIZATION_DETAIL_DESCRIPTIONS);
     ...
     */
    private Map<String, String> saveAuthorizationDetailsById(Map<String, String> authorizationDetailDescriptions,
                                                             HttpServletRequest req, HttpServletResponse resp)
    {
        Map<String, String> idToAuthorizationDetails = new HashMap<>();
        Map<String, String> idToDescriptions = new HashMap<>();

        for (Map.Entry<String, String> entry: authorizationDetailDescriptions.entrySet())
        {
     ...
     */
    private String getNextId(Map<String, String> idToAuthorizationDetails)
    {
        int randomId;
        do
        {
